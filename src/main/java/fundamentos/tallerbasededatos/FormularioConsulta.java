...
public class FormularioConsulta extends javax.swing.JPanel {
    ...
    public FormularioConsulta(String user, String password) {
        initComponents();
        this.user = user;
    ...
    private void initComponents() {
        ...
        tblSede.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "idSd", "nombreSd", "direccionSd", "telefonoSd"
            }
        ));
    ...
    private void btnBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBuscarMouseClicked
        ...
        mostrarDatos(tblSede, Id);
    }//GEN-LAST:event_btnBuscarMouseClicked

    public void mostrarDatos(JTable tabla, int Id) {
        DefaultTableModel modelo = new DefaultTableModel();
        tabla.setModel(modelo);

        try {
            Connection con = new CConexion().Conexion(user, password);
            PreparedStatement ps = con.prepareStatement("execute sp_consultaDatos ?");
